...
#include "Abilities/TargetActors/GATA_Trace_Shooter.h"
#include "AbilitySystemComponent.h"
#include "DrawDebugHelpers.h"
#include "GameFramework/PlayerController.h"
#include "GameplayAbilitySpec.h"

AGATA_Trace_Shooter::AGATA_Trace_Shooter()
{
...
void AGATA_Trace_Shooter::ResetSpread()
{
	bUseAimingSpreadMod = false;
	BaseSpread = 0.0f;
	AimingSpreadMod = 0.0f;
...
float AGATA_Trace_Shooter::GetCurrentSpread() const
{
...
void AGATA_Trace_Shooter::SetStartLocation(const FGameplayAbilityTargetingLocationInfo& InStartLocation)
{
	StartLocation = InStartLocation;
}

void AGATA_Trace_Shooter::SetShouldProduceTargetDataOnServer(bool bInShouldProduceTargetDataOnServer)
{
	ShouldProduceTargetDataOnServer = bInShouldProduceTargetDataOnServer;
}

void AGATA_Trace_Shooter::SetDestroyOnConfirmation(bool bInDestroyOnConfirmation)
{
	bDestroyOnConfirmation = bInDestroyOnConfirmation;
}

void AGATA_Trace_Shooter::StartTargeting(UGameplayAbility* Ability)
{
...
void AGATA_Trace_Shooter::ConfirmTargetingAndContinue()
{
...
void AGATA_Trace_Shooter::CancelTargeting()
{
...
void AGATA_Trace_Shooter::BeginPlay()
{
	Super::BeginPlay();
...
void AGATA_Trace_Shooter::EndPlay(const EEndPlayReason::Type EndPlayReason)
{
	DestroyReticleActors();
...
void AGATA_Trace_Shooter::Tick(float DeltaSeconds)
{
...
void AGATA_Trace_Shooter::LineTraceWithFilter(TArray<FHitResult>& OutHitResults, const UWorld* World,
...
void AGATA_Trace_Shooter::AimWithPlayerController(const AActor* InSourceActor, FCollisionQueryParams Params,
...
bool AGATA_Trace_Shooter::ClipCameraRayToAbilityRange(FVector CameraLocation, FVector CameraDirection, FVector AbilityCenter,
...
void AGATA_Trace_Shooter::StopTargeting()
{
	SetActorTickEnabled(false);
...
FGameplayAbilityTargetDataHandle AGATA_Trace_Shooter::MakeTargetData(const TArray<FHitResult>& HitResults) const
{
...
TArray<FHitResult> AGATA_Trace_Shooter::PerformTrace(AActor* InSourceActor)
{
...
AGameplayAbilityWorldReticle* AGATA_Trace_Shooter::SpawnReticleActor(FVector Location, FRotator Rotation)
{
	if (ReticleClass)
	{
...
void AGATA_Trace_Shooter::DestroyReticleActors()
{
