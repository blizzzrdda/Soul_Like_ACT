#pragma once
#include "GATA_Reusable.h"
#include "GATA_Reusable_Sphere.generated.h"
UCLASS()
class AGATA_Reusable_Sphere : public AGATA_Reusable
{
	GENERATED_BODY()

public:
	AGATA_Reusable_Sphere();
	...
	/**
		...
		* InAimingRemovalTag.
		* @param InTraceRange Max range for this trace.
	...
	void Configure(
		...
		UPARAM(DisplayName = "Trace Toward Player Front") bool InbTraceTowardPlayerFront = true,
		UPARAM(DisplayName = "Trace Range") float InTraceRange = 100.0f,
		...
		UPARAM(DisplayName = "Max Hit Results Per Trace") int32 InMaxHitResultsPerTrace = 20,
